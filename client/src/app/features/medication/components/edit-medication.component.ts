...
export class EditMedicationComponent {
  ...
  loadMedication() {
    this.#medicationService.getMedicationById(this.medication_id)
      .subscribe(response => {
        this.medicationForm.get('_id')?.setValue(response.data._id);
        this.medicationForm.get('name')?.setValue(response.data.name);
        this.medicationForm.get('generic_name')?.setValue(response.data.generic_name);
        this.medicationForm.get('medication_class')?.setValue(response.data.medication_class);
        this.medicationForm.get('availability')?.setValue(response.data.availability);

        this.image = { name: response.data.image.originalname };
      })
  }
  ...
  handleSubmit() {
    if(this.medicationForm.valid) {
      ...
      const _id = this.medicationForm.get('_id')?.value as string;
